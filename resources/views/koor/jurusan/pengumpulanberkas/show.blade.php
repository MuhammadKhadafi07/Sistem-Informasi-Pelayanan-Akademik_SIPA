<x-module.koor.jurusan>
    <x-template.button.back-button url="koor/jurusan/pengumpulanberkas" />
    <div class="card">
        <div class="card-header">
            <form action="{{ url('koor/jurusan/pengumpulanberkas/konfirmasi', $pengumpulanberkas->id) }}" method="post"
