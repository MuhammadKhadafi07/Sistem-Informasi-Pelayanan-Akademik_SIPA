<x-module.alumni>
    <x-template.button.back-button url="alumni/etiket" />
    <div class="card">
        <div class="card-header">
            <div class="card-title">Etiket</div>
        </div>
        <div class="card-body">
            <form action="{{ url('alumni/etiket') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="file" name="foto_bukti" accept=".jpg, .png, .pdf, .jpeg" class="form-control">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
