<x-module.koor.perpustakaan>
    <x-template.button.back-button url="koor/perpustakaan/pengumpulanberkas" />
    <div class="card">
        <div class="card-header">
            <form action="{{ url('koor/perpustakaan/pengumpulanberkas/konfirmasi', $pengumpulanberkas->id) }}"
                method="post" onsubmit="return confirm('Yakin ingin mengonfirmasi pengajuan ini?')">
                @csrf
                @method('put')
