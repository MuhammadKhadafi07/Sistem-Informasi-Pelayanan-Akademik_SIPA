<x-module.koor.perpustakaan>
    <x-template.button.back-button url="koor/perpustakaan/riwayatpengumpulanberkas" />
    <div class="card">
        <div class="card-header">
            <form action="{{ url('koor/perpustakaan/riwayatpengumpulanberkas/cancel', $pengumpulanberkas->id) }}"
