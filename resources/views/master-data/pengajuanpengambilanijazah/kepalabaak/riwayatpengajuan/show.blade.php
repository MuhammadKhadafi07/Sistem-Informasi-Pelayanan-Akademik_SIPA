<x-module.pengajuanpengambilanijazah.kepalabaak>
    <x-template.button.back-button url="pengajuanpengambilanijazah/kepalabaak/riwayatpengajuan" />
    <div class="card">
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl class="row">
                        ...
                        <dd class="col-md-9">: {{ $pengajuanpengambilanijazah->mahasiswa->nama }}</dd>
                        <dt class="col-md-3">NIM</dt>
                        <dd class="col-md-9">: {{ $pengajuanpengambilanijazah->mahasiswa->nim }}</dd>
