<x-module.alumni>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <form action="{{ url('alumni/alumnis', $alumni->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="card">
                ...
                <div class="card">
                    <div class="card-header bg-light">
                        ...
                        <label for="" class="label text-danger pl-1"> *Kosongkan data ini jika belum
                            kerja.</label>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_pekerjaan" class="form-control" id="jenis_pekerjaan1">
                                        @if ($alumni->jenis_pekerjaan == 1)
                                            <option value="1" selected>{{ $alumni->jenis_pekerjaan_lainnya }}
                                            </option>
                                        @else
                                            <option>{{ $alumni->jenis_pekerjaan }}</option>
                                        @endif
                                        <option value=""></option>
                                ...
                                <div class="form-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="jenis_pekerjaan_lainnya"
                                            value="{{ $alumni->jenis_pekerjaan_lainnya }}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <select name="kategori_perusahaan" class="form-control"
                                        ...
                                        @if ($alumni->kategori_perusahaan == 1)
                                            <option value="1" selected>
                                                {{ $alumni->kategori_perusahaan_lainnya }}
                                            </option>
                                        @else
                                            <option>{{ $alumni->kategori_perusahaan }}</option>
                                        @endif
                                        <option value=""></option>
                                ...
                                <div class="form-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="kategori_perusahaan_lainnya" class="form-control"
                                            value="{{ $alumni->kategori_perusahaan_lainnya }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="saran_masukan" required class="form-control">{{ $alumni->saran_masukan }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="kesan" required class="form-control">{{ $alumni->kesan }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
