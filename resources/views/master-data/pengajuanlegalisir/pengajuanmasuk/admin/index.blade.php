                    ...
                    @foreach ($list_pengajuanlegalisir->sortByDesc('created_at')->values() as $pengajuanlegalisir)
                        @if ($pengajuanlegalisir->status == 1)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ url('pengajuanlegalisir/admin/pengajuanlegalisir', $pengajuanlegalisir->id) }}"
                                            class="btn btn-dark btn-sm"><i class="fas fa-info"></i> Detail</a>
                                        <a href="{{ url('pengajuanlegalisir/admin/pengajuanlegalisir', $pengajuanlegalisir->id) }}/selesai"
                                            class="btn btn-success btn-sm"><i class="fas fa-check"></i> Selesai</a>
                                    </div>
                                </td>
